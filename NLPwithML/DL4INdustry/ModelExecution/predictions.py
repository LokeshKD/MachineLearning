...
## Restore and Inference Model and retrieve specific tensors
## Make predictios using saved inference model.
...
class ClassificationModel(object):
    ...
    def load_inference_parts(self, sess, saved_model_dir):
        # CODE HERE
        tags = [tf.saved_model.tag_constants.SERVING]
        tf.saved_model.loader.load(sess, tags, saved_model_dir)
